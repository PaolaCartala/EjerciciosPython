...
"""
Usar un contador (objeto Counter) para contar cajones de frutas para que las entradas múltiples como Mandarina y Naranja en camion se combinen en una sola entrada
"""
...
# Listar las tres frutas con mayores tenencias
print(tenencias.most_common(3))

# Carga los datos de otro camión con cajones de fruta en un nuevo contador
...
# Esto es solo una pequeña muestra de lo que se puede hacer con contadores. El módulo collections es muy poderoso.
